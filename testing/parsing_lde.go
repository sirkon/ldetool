...
func (p *Decoders) Extract(line []byte) (bool, error) {
	...
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 8); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int8): %s", *(*string)(unsafe.Pointer(&tmp)), "Int8", err)
	}
	p.Int8 = int8(tmpInt)
	...
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 16); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int16): %s", *(*string)(unsafe.Pointer(&tmp)), "Int16", err)
	}
	...
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 32); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int32): %s", *(*string)(unsafe.Pointer(&tmp)), "Int32", err)
	}
	...
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 64); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int64): %s", *(*string)(unsafe.Pointer(&tmp)), "Int64", err)
	}
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 10, 8); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint8): %s", *(*string)(unsafe.Pointer(&tmp)), "Uint8", err)
	}
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 10, 16); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint16): %s", *(*string)(unsafe.Pointer(&tmp)), "Uint16", err)
	}
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 10, 32); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint32): %s", *(*string)(unsafe.Pointer(&tmp)), "Uint32", err)
	}
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 10, 64); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint64): %s", *(*string)(unsafe.Pointer(&tmp)), "Uint64", err)
	}
	...
	if tmpFloat, err = strconv.ParseFloat(*(*string)(unsafe.Pointer(&tmp)), 32); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(float32): %s", *(*string)(unsafe.Pointer(&tmp)), "Float32", err)
	}
	...
	if tmpFloat, err = strconv.ParseFloat(*(*string)(unsafe.Pointer(&tmp)), 64); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(float64): %s", *(*string)(unsafe.Pointer(&tmp)), "Float64", err)
	}
...
func (p *Prefixes) Extract(line []byte) (bool, error) {
	...
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 32); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int32): %s", *(*string)(unsafe.Pointer(&tmp)), "Data", err)
	}
	p.Data = int32(tmpInt)
	...
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 32); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int32): %s", *(*string)(unsafe.Pointer(&tmp)), "Rest1", err)
	}
...
func (p *FixedLook) Extract(line []byte) (bool, error) {
	...
	if pos >= 0 {
		...
		return false, fmt.Errorf("Cannot find `\033[1m%s\033[0m` in `\033[1m%s\033[0m` to bound data for field Data", const123456789, string(tmpRest))
	}
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 32); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int32): %s", *(*string)(unsafe.Pointer(&tmp)), "Data", err)
	}
	...
	if pos >= 0 {
		...
		return false, fmt.Errorf("Cannot find `\033[1m%s\033[0m` in `\033[1m%s\033[0m` to bound data for field Rest1", const34, string(tmpRest))
	}
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 32); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int32): %s", *(*string)(unsafe.Pointer(&tmp)), "Rest1", err)
	}
...
urlUserLabel:
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 10, 16); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint16): %s", *(*string)(unsafe.Pointer(&tmp)), "Port", err)
	}
...
func (p *IncludeChar) Extract(line []byte) (bool, error) {
	...
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&tmp)), 10, 64); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int): %s", *(*string)(unsafe.Pointer(&tmp)), "Field2", err)
	}
	p.Field2 = int(tmpInt)
...
func (p *Hex) Extract(line []byte) (bool, error) {
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 16, 64); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint): %s", *(*string)(unsafe.Pointer(&tmp)), "F1", err)
	}
	p.F1 = uint(tmpUint)
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 16, 8); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint8): %s", *(*string)(unsafe.Pointer(&tmp)), "F2", err)
	}
	p.F2 = uint8(tmpUint)
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 16, 16); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint16): %s", *(*string)(unsafe.Pointer(&tmp)), "F3", err)
	}
	p.F3 = uint16(tmpUint)
	...
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&tmp)), 16, 32); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint32): %s", *(*string)(unsafe.Pointer(&tmp)), "F4", err)
	}
	p.F4 = uint32(tmpUint)

	// Take the rest as F5(hex64)
	if tmpUint, err = strconv.ParseUint(*(*string)(unsafe.Pointer(&p.Rest)), 16, 64); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(uint64): %s", *(*string)(unsafe.Pointer(&p.Rest)), "F5", err)
	}
	p.F5 = uint64(tmpUint)
	p.Rest = p.Rest[len(p.Rest):]
	return true, nil
...
func (p *Dec) Extract(line []byte) (bool, error) {
	...
	if p.F1, err = decconv.Decode32(8, 3, tmp); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(dec8.3): %s", string(tmp), "F1", err)
	}
	...
	if p.F2, err = decconv.Decode64(12, 2, tmp); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(dec12.2): %s", string(tmp), "F2", err)
	}

	// Take the rest as F3(dec128)
	if p.F3.Lo, p.F3.Hi, err = decconv.Decode128(30, 8, p.Rest); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(dec30.8): %s", string(p.Rest), "F3", err)
	}
	p.Rest = p.Rest[len(p.Rest):]
	return true, nil
}
...
func (p *Star) Extract(line []byte) (bool, error) {
	...
	if tmpInt, err = strconv.ParseInt(*(*string)(unsafe.Pointer(&p.Rest)), 10, 64); err != nil {
		return false, fmt.Errorf("cannot parse `%s` into %s(int): %s", *(*string)(unsafe.Pointer(&p.Rest)), "F", err)
	}
	p.F = int(tmpInt)
	p.Rest = p.Rest[len(p.Rest):]
	return true, nil
